...
class _95du {
      ...
      items: [
        {
          ...
          name: 'reset',
          type: 'cell',
          icon: `${this.rootUrl}/img/symbol/reset.png`
        },
        {
          label: '清除缓存',
          name: 'clearCache',
        ...
        },
        {
          ...
          type: 'cell',
          input: true,
          icon: `${this.rootUrl}/img/symbol/refresh.png`,
          message: '设置桌面组件的时长\n( 单位: 分钟 )',
  ...
  // 背景菜单
  backgroundMenus = (settings, backgroundImage) => {
    return [
      {
        label: '渐变角度、颜色',
        type: 'group',
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            type: 'cell',
            input: true,
            icon: `${this.rootUrl}/img/symbol/masking_2.png`,
          ...
          },
          {
            ...
            name: 'background',
            type: 'cell',
            icon: `${this.rootUrl}/img/symbol/transparent.png`
          },
          {
            label: '遮罩透明',
            name: 'masking',
          ...
          },
          {
            ...
            type: 'file',
            isDesc: true,
            icon: `${this.rootUrl}/img/symbol/bgImage.png`,
            desc: this.fm.fileExists(backgroundImage) ? '已添加' : ' '
          },
          {
            label: '清除背景',
            name: 'clearBgImg',
            type: 'cell',
            icon: `${this.rootUrl}/img/symbol/clearBg.png`
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            name: 'update',
            type: 'switch',
            icon: `${this.rootUrl}/img/symbol/update.png`
          },
          {
            label: '背景音乐',
            name: 'music',
