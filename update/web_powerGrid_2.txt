 ...
 /**
  ...
  const setBackground = async (widget) => {
    ...
    if (fm.fileExists(bgImage) && !Appearance) {
      ...
      widget.backgroundImage = await getCacheImage("bg.png", 'https://raw.githubusercontent.com/95du/scripts/master/img/picture/background_image_1.png');
    } else {
      const baiTiaoUrl = ['https://github.com/95du/scripts/blob/master/img/jingdong/baiTiaoBg2.png'];
