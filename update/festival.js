...
const setBackground = async (widget) => {
  if (daysUntil > 0) {
    widget.backgroundImage = await getCacheData('background.jpeg', 'https://sweixinfile.hisense.com/media/M00/89/EF/Ch4FyWb6GT-AIwYcAAEcQ80cGUM620.png');
  } else {
