...
async function main() {
  ...
  const scrUrl = `${rootUrl}/api/web_sports_playerRank.js`;
  ...
  const renderAppView = async (options) => {
     ...
     */
    const widgetMessage = '1，支持百度体育官网中大部分赛事<br>2，如需多个赛事组件，在桌面组件参数输入对应的赛事名称，例如: 西甲、英超、CBA、NBA';
     ...
     */
    const previewImgUrl = [
      `${rootUrl}/img/picture/sports_playerRank_0.png`,
      `${rootUrl}/img/picture/sports_playerRank_1.png`
    ];
